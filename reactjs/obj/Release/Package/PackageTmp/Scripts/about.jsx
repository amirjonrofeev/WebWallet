        ...
        return <table>
            <tr>
                ...
                <td className="userInformation">
                    <p><h1>Информация о пользователе</h1></p>
                    <p><b>Hash - кошелка:</b> {this.data.WalletID}</p>
                    <p><b>Логин:</b> {this.data.Login}</p>
                    <p><b>Пароль:</b>{this.data.Password}</p>
                    <p><b>Электронная почта:</b> {this.data.Email}</p>
                    <p><b>Имя:</b> {this.data.FirstName}</p>
                    <p><b>Фамилия:</b> {this.data.MiddleName}</p>
                    <p><b>Отчество:</b> {this.data.LastName}</p>
                </td>
            </tr>
        </table>;
    }
